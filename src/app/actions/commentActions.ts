...
const RANDOM_NAMES = [
  "오사카러버", "여행가고파", "김다은", "박지민", "travelholic99", "일본여행자", "osaka_fan", "최민수", "스시킬러", "도톤보리짱", 
  "이진우", "wanderlust88", "kyoto_dream", "정윤희", "백패커킴", "한소희", "오사카정복자", "맛집탐험대", "유니버셜가자", "tasty_japan", 
  "김지훈", "박서준", "이지은", "최아린", "오사카투어", "일본여행매니아", "travel_bug", "사쿠라유키", "김태형", "박보검",
  "minji_kim", "osaka_trip_99", "우동조아", "라멘매니아", "현지인맛집", "칸사이특급", "제주항공러버", "난바역에서", "우메다쇼핑", "신오사카역"
];
