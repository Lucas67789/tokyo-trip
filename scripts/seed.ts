...
async function seed() {
  ...
  const { error: err4 } = await supabase.from('stations').upsert([
    { id: 's0000000-0000-0000-0000-000000000001', city_id: 'c1000000-0000-0000-0000-000000000001', slug: 'namba', name_ko: '신주쿠역', name_en: 'Namba', name_jp: 'なんば', description: '도쿄 남부의 중심. 시부야 스크램블 교차로, 신사이바시 등 주요 관광지와 연결되어 있으며, 나리타 공항 직통열차(스카이라이너)가 정차합니다.' },
    { id: 's0000000-0000-0000-0000-000000000002', city_id: 'c1000000-0000-0000-0000-000000000001', slug: 'umeda', name_ko: '시부야역', name_en: 'Umeda', name_jp: '梅田', description: '도쿄 북부의 교통 요지. 거대한 지하도와 수많은 백화점이 밀집해 있어 쇼핑의 천국으로 불립니다.' },
    { id: 's0000000-0000-0000-0000-000000000003', city_id: 'c1000000-0000-0000-0000-000000000001', slug: 'shinsaibashi', name_ko: '신사이바시역', name_en: 'Shinsaibashi', name_jp: '心斎橋', description: '도쿄의 대표적인 쇼핑 거리. 다이마루 백화점과 명품 거리가 위치해 있습니다.' }
  ], { onConflict: 'slug' });
  ...
  const { error: err6 } = await supabase.from('hotels').upsert([
    ...
    { id: 'h0000000-0000-0000-0000-000000000002', station_id: 's0000000-0000-0000-0000-000000000001', slug: 'hotel-gracery-shinjuku', name_ko: '칸데오 호텔스 도쿄 신주쿠', name_en: 'Candeo Hotels Tokyo Namba', star_rating: 4.0, review_score: 8.6, review_count: 3215, lowest_price: 135000, thumbnail_url: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=800&q=80', tags: ['대욕장', '신주쿠도보5분', '가성비'], view_count: 312 },
